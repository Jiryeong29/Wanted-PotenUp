...
#include <iostream>
DonationAccount::DonationAccount(int id, const char* name, int balance, const char* accountType)
	:Account(id, name, balance, accountType), donateRate(0.01f), donataAmount(0)
{
}
